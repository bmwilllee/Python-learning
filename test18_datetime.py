...
from datetime import datetime
dt = datetime(2015, 4, 19, 12, 20)	# 用制定日期创建datetime
print(dt)
#	datetime()函数非常只能，如果所设置的时间不合理，就会报错
...
2017-06-19 21:00:00 UTC+8:00

#	而此刻的格林威治标准时间与北京时间差了8小时，也就是UTC+0:00时区的时间应该是：
2017-06-19 13:00:00 UTC+0:00
...
2015-04-19 12:20:00
print(datetime.utcfromtimestamp(t)) # UTC时间 用utcfromtimestamp()函数
2015-04-19 04:20:00
...
#	返回值为：	Mon, May 05 16:28


#			datetime加减

#	对日期和时间进行加减实际上就是把datetime往后或往前计算
#	到新的datetime。加减可以直接用+和-运算符，不过需要导入timedelta这个类：
...
now = now + timedelta(days = 1, hours = 10)
...
#	或者：
dt = datetime.now().replace(tzinfo = timezone(timedelta(hours = 8)))
...
print(utc_dt)
#	返回：2015-05-18 09:05:12.377316+00:00
# astimezone()将转换时区为北京时间:
bj_dt = utc_dt.astimezone(timezone(timedelta(hours=8)))
print(bj_dt)
#	返回：2015-05-18 17:05:12.377316+08:00
# astimezone()将转换时区为东京时间:
tokyo_dt = utc_dt.astimezone(timezone(timedelta(hours=9)))
print(tokyo_dt)
#	返回：2015-05-18 18:05:12.377316+09:00
