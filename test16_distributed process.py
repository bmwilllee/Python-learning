...
QueueManager.register('get_task_queue', callable = lamda: task_queue)
QueueManager.register('get_result_queue', callable = lamda: result_queue)
# 绑定端口5000, 设置验证码'abc':
...
print('Connect to server %s...' % server_sddr)
# 端口和验证码注意保持与task_master.py设置的完全一致:
m = QueueManager(address = (server_sddr, 5000), authkey = b'abc')
# 从网络连接:
m.connect()
# 获取Queue的对象:
