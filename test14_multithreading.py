...
t2 = threading.Thread(target = run_thread, args(60,))
...
t1: x1 = balance - 5  # x1 = 5 - 5 = 0
t1: balance = x1      # balance = 0
t2: x2 = balance - 8  # x2 = 0 - 8 = -8  (注意这里，balabce在重新进入进程后会被初始化,z看上面代码的第一行)
t2: balance = x2   # balance = -8
...
#	如果我们要确保balance计算正确，就要给changeBalance()上一把锁
#	当某个线程开始执行changeBalance()时，我们说，该线程因为获得了锁
#	因此其他线程不能同时执行changeBalance()，只能等待，直到锁被释放后，获得该锁以后才能改
